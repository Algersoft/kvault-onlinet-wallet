...
// Forking config.
var addressFormat = "^ZkRiEGER([a-zA-Z0-9]{94}|[a-zA-Z0-9]{182})$"
var divisor float64 = 1000000 // This is 1000000 for KREGR
var transactionFee = 10000 // This is 10000 for KREGR
...
func getStatus(res http.ResponseWriter, req *http.Request, p httprouter.Params) {
	...
	kregr := temp["result"].(map[string]interface{})["availableBalance"].(float64) / divisor
	temp["result"].(map[string]interface{})["availableBalance"] = kregr
	kregr = temp["result"].(map[string]interface{})["lockedAmount"].(float64)
	temp["result"].(map[string]interface{})["lockedAmount"] = kregr / divisor
